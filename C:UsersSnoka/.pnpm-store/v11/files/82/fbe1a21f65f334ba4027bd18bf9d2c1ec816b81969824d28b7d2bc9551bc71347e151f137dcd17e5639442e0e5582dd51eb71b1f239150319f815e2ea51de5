...
__esmMin((() => {
	...
	Ri = Object.getPrototypeOf, Vi = Object.prototype.hasOwnProperty;
	ot = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), Oi = (e, t) => {
	...
	ut = (e, t, i) => (i = e != null ? Ii(Ri(e)) : {}, Bi(t || !e || !e.__esModule ? Be(i, "default", {
		value: e,
		enumerable: !0
	}) : i, e));
	Qt = ot((xr, zt) => {
...
`;
	...
	Si = ut($e(), 1);
	Ae = As;
	te = (e, t) => (i, s, ...r) => i | 1 && s == null ? void 0 : (t.call(s) ?? s[e]).apply(s, r);
	ks = Array.prototype.findLast ?? function(e) {
	...
	Pe = Gs;
	qs = String.prototype.replaceAll ?? function(e, t) {
	...
	mi = $s;
	Ie = Zs;
	Ne = "module", vi = "script", Le = "commonjs", Re = [Ne, Le];
	er = {
		ecmaVersion: "latest",
		allowReserved: !0,
