...
var Hs, Re, Ks, kt, R, Q, Dt, Js, Mt, be, Gs, Xs, Ys, Qs, Zs, ei, p, ri, Ft, ai, W, E, T, m, Ue, oe, j, ni, we, ft, pe, dt, mt, yt, xt, Pt, gt, oi, bt, Xt, Pi, gi, Yt, Ti, At, bi, Ai, Si, Ei, ue, fe, He, We, Ni, g, vi, Di, Mi, ge, _e, je, U, Bi, Je, Ge, Xe, Ye, Qe, Ze, Ui, _t, Te, Vi, tt, st, it, rt, Z, Ce, at, nt, Y, de, Vt, ot, ht, ct, Ve, y, Ji, $t, Qi, Zi, Kt, Ht, hs, tr, pt, ze, sr, ir, qe, ut, Ee, Wt, cs, ls, ps, us, fs, ds, ms, ve, ee, ur, xs, Ps, te, se, gs, St, Ts, wt, Ct, bs, As, me, wr, Ss, c, Cs, Es, Ns, De, ks, Me, vr, xe, Dr, Mr, Or, Fr, vs, Br, Ls, Rr, Ur, Os, Fs, H, Oe, Nt, Fe, ie, Vr, js, Vs, _, zr, Hr, zs, Wr, Jr, Gr, Xr, qs, Yr, Lt, vt, $s, ea, ta, sa, ia, ra;
var init_babel = __esmMin((() => {
	...
	Dt = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED", Js = {
...
- Did you mean \`import { "${a}" as foo }\`?`,
	...
	({defineProperty: ri} = Object), Ft = (a, t) => {
		a && ri(a, t, {
			enumerable: !1,
			value: a[t]
		});
	};
	ai = (a) => class extends a {
		parse() {
	...
	Di = /\*?\s*@((?:no)?flow)\b/, Mi = (a) => class extends a {
		flowPragma = void 0;
		getScopeHandler() {
			return We;
		}
...
` || a === "\r" || a === "\u2028" || a === "\u2029";
	...
	ms = lr;
	ve = pr;
	ee = (a, t) => (e, s, ...i) => e | 1 && s == null ? void 0 : (t.call(s) ?? s[a]).apply(s, i);
	ur = Array.prototype.findLast ?? function(a) {
	...
	Ns = Ir;
	De = Nr;
	ks = "Unexpected parseExpression() input: ";
	Me = kr;
	vr = String.prototype.replaceAll ?? function(a, t) {
...
//#endregion
init_babel();
export { Ks as default, init_babel as n, ra as parsers, babel_exports as t };
