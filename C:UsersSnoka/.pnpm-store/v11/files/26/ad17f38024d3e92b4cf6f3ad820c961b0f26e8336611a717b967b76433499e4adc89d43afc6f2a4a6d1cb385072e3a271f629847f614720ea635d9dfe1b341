...
`, sm = 2;
	...
	$i = Re(Tr(), 1);
	_l = () => {}, tr = _l;
	V = "string", j = "array", be = "cursor", ee = "indent", re = "align", De = "trim", X = "group", J = "fill", Q = "if-break", pe = "indent-if-break", he = "line-suffix", de = "line-suffix-boundary", $ = "line", me = "label", te = "break-parent", Br = new Set([
		be,
		ee,
		re,
		De,
...
${e}`;
	...
	vf = new Set(["listItem", "definition"]);
	_t = class {
		#e;
		constructor(r) {
			this.#e = new Set(r);
